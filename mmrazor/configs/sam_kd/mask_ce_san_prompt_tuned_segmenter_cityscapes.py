...
val_interval = int(1600/num_gpus)
...
val_dataloader = dict(batch_size=1, dataset=dict(metainfo=metainfo), num_workers=8)
...
model = dict(
    ...
    distiller=dict(
        ...
        distill_losses=dict(
            loss_kd=dict(type='MaskedCrossEntropyLoss', loss_weight=1,
                         class_logits_threshold_path='./checkpoints/cityscapes_class_san_threshold_logits.pkl')),
