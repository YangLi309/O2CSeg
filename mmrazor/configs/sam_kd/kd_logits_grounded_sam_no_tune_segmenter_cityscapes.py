...
teacher_cfg_path = 'mmseg::sam_kd/official_grounded_sam_cityscapes-1024x1024_no_prompt_tune_kd.py'
...
model = dict(
    ...
    distiller=dict(
        ...
        distill_losses=dict(
            loss_kd_before_proj=dict(type='MaskedKLDivergence', tau=1, loss_weight=batch_size, reduction='mean'),
