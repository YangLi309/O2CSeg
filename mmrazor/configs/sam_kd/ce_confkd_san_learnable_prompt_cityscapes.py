...
num_gpus = 1
batch_size = 2
teacher_ckpt = 'checkpoints/best_san_learnable_prompt_non_csc_4ctx_cityscapes.pth'
teacher_cfg_path = 'mmseg::sam_kd/san-vit-l14_cityscapes_learnable_prompt_non_csc_4ctx_kd.py'  # noqa: E501
...
model = dict(
    ...
    # disable supervised learning from the student model
