...
from .cross_entropy_loss import CrossEntropyLoss, MaskedCrossEntropyLoss
...
from .kl_divergence import KLDivergence, MaskedKLDivergence, ConfKLDivergence
...
__all__ = [
    'ChannelWiseDivergence', 'KLDivergence', 'MaskedKLDivergence', 'AngleWiseRKD', 'DistanceWiseRKD',
    'WSLD', 'L2Loss', 'ABLoss', 'DKDLoss', 'KDSoftCELoss', 'ActivationLoss',
    'OnehotLikeLoss', 'InformationEntropyLoss', 'FTLoss', 'ATLoss', 'OFDLoss',
    'L1Loss', 'FBKDLoss', 'CRDLoss', 'CrossEntropyLoss', 'MaskedCrossEntropyLoss', 'PKDLoss', 'MGDLoss',
    'DISTLoss', 'ConfKLDivergence', 'DiceLoss'
]
