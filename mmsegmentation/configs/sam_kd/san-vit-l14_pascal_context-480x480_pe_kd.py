...
class_mapping = {
    'cloth': ['cloth', 'shirt'],
    'bed': ['bed', 'mattress'],
    'ground': ['ground', 'soil', 'terrain', 'land'],
    'window': ['window', 'glass window'],
    'motorbike': ['motor', 'motorcycle', 'scooter'],
    'truck': ['van', 'pickup', 'lorry']
}
...
model = dict(
    ...
    decode_head=dict(
        exp_name='san_pascal_context_pe',
        ...
        visualize_classes=['bed', 'bench', 'cloth', 'ground', 'door', 'sidewalk', 'truck', 'wood'],
        save_pseudo_logits=True,
        pseudo_save_dir='san_prompt_expanded_logits_cityscapes_pascal_context',
        loss_decode=[
            dict(
